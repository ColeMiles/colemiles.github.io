...
export function __wbg_oldtuner_free(a: number): void;
export function __wbg_get_oldtuner_mean_obs(a: number): number;
export function __wbg_set_oldtuner_mean_obs(a: number, b: number): void;
export function __wbg_get_oldtuner_mean_obs_sq(a: number): number;
export function __wbg_set_oldtuner_mean_obs_sq(a: number, b: number): void;
export function __wbg_get_oldtuner_mean_field(a: number): number;
export function __wbg_set_oldtuner_mean_field(a: number, b: number): void;
export function __wbg_get_oldtuner_var_mean_obs(a: number): number;
export function __wbg_set_oldtuner_var_mean_obs(a: number, b: number): void;
export function __wbg_get_oldtuner_var_mean_field(a: number): number;
export function __wbg_set_oldtuner_var_mean_field(a: number, b: number): void;
export function oldtuner_new(a: number, b: number, c: number, d: number, e: number, f: number): number;
export function oldtuner_update(a: number, b: number, c: number): number;
export function oldtuner_get_kappa(a: number): number;
export function oldtuner_get_kappa_min(a: number): number;
export function oldtuner_get_kappa_max(a: number): number;
export function oldtuner_reset(a: number, b: number, c: number, d: number): void;
